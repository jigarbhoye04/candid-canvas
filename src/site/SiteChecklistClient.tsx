   ...
   return (
      <div className="max-w-xl w-full">
               ...
               <>
                  ...
                  >
                     ...
                     >
                        ...
                        Store your OpenAI secret key in order to add
                        experimental support for AI-generated text descriptions
                        and enable an invisible field called{" "}
                        {'"Semantic Description"'} used to support CMD-K search
                     ...
                     >
                        ...
                        photos. Accepted values: title, caption, tags,
                        description, all, or none (default is {'"all"'}).
                  ...
                  >
                     <ChecklistRow
                        ...
                        optional
                     >
                        Set environment variable to {'"1"'} to enable higher
                     ...
                     >
                        ...
                        optimization, i.e., rendering pages and images at build
                        time:
                        {renderSubStatus(
                     ...
                     <ChecklistRow
                        ...
                        optional
                     >
                        Set environment variable to {'"1"'} to constrain the
                        size of each photo, and enable a surrounding border:
                     ...
                     <ChecklistRow
                        ...
                        optional
                     >
                        Set environment variable to {'"1"'} to prevent image
                        blur data being stored and displayed
                     ...
                     <ChecklistRow
                        ...
                        optional
                     >
                        Set environment variable to {'"1"'} to prevent priority
                        order photo field affecting photo order
                     ...
                     <ChecklistRow
                        ...
                        optional
                     >
                        Set environment variable to {'"1"'} to enable a public
                        API available at <code>/api</code>:
                     ...
                     <ChecklistRow
                        ...
                        optional
                     >
                        Set environment variable to {'"1"'} to hide X button
                        from share modal:
                     ...
                     >
                        ...
                        simulations showing up in /grid sidebar and CMD-K search
                        results:
                     ...
                     <ChecklistRow
                        ...
                        optional
                     >
                        Set environment variable to any number to enforce aspect
                        ratio (default is {'"1"'}, i.e., square)—set to {'"0"'}{" "}
                        to disable:
                     ...
                     <ChecklistRow
                        ...
                        optional
                     >
                        Set environment variable to {'"BOTTOM"'} to keep OG
                        image text bottom aligned (default is {'"top"'}):
         ...
         <div className="pl-11 pr-2 sm:pr-11 mt-4 md:mt-7">
            <div>
               Changes to environment variables require a redeploy or reboot of
               local dev server
            </div>
            {!simplifiedView && (
